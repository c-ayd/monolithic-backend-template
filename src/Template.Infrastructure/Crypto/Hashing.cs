...
namespace Template.Infrastructure.Crypto
{
    public class Hashing : IHashing
    {
        ...
        public string HashPassword(string password)
        {
            ...
            var salyBytes = hashedPasswordBytes.Slice(1, _currentHashing.SaltSize);
            var keyBytes = hashedPasswordBytes.Slice(1 + _currentHashing.SaltSize, _currentHashing.KeySize);
        ...
        public EPasswordVerificationResult VerifyPassword(string hashedPassword, string password)
        {
            ...
            var saltBytes = hashedPasswordBytes.Slice(1, _hashing.SaltSize);
            var keyBytes = hashedPasswordBytes.Slice(1 + _hashing.SaltSize, _hashing.KeySize);
